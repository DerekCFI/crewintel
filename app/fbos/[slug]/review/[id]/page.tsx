...
export default function HotelDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <Link href={`/fbos/${params.slug}`} className="text-brand-blue hover:text-brand-blue/80">
            ← Back to FBO Reviews
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Back button */}
        <Link href={`/fbos/${params.slug}`} className="text-brand-blue hover:text-brand-blue/80 mb-4 inline-block">
          ← Back to FBO Reviews
        </Link>
        ...
        {/* Amenities & Services */}
        <div className="bg-white rounded-lg shadow-md p-8 mb-6">
          <h2 className="text-2xl font-bold text-brand-navy mb-6">Services & Amenities</h2>
