      ...
      <main className="p-4 pb-20">
        ...
        {activeTab === 'dashboard' && stats && (
          <div className="space-y-4">
            {/* Alert Cards */}
            {(stats.pendingLocations > 0 || stats.flaggedReviews > 0) && (
            ...
            <div className="space-y-3">
              {reviews.map((review) => (
                <div key={review.id} className="bg-white rounded-lg p-4 shadow">
                  ...
                  <p className="text-gray-700 text-sm mb-2 line-clamp-3">{review.review_text}</p>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {review.flagged ? 'Unflag' : 'Flag as Spam'}
                    </button>
                    <button
