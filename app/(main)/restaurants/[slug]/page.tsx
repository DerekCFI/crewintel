...
export default function BusinessPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <Link href="/restaurants" className="text-brand-blue hover:text-brand-blue/80">
            ← Back to Restaurants
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <Link href="/restaurants" className="text-brand-blue hover:text-brand-blue/80 mb-4 inline-block">
          ← Back to Restaurants
        </Link>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-right">
              ...
              {business.quick_log_count > 0 && business.quick_log_count === business.review_count && (
                <span className="inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded bg-blue-100 text-blue-700 mt-2">
                  ⚡ Quick Log Only
                </span>
              )}
            </div>
            ...
            <div key={review.id} className="bg-white rounded-lg shadow-md p-6">
              <div className="flex justify-between items-start mb-4">
                <div className="flex flex-col gap-1">
                  ...
                  {review.is_quick_log && (
                    <span className="inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded bg-blue-100 text-blue-700 w-fit">
                      ⚡ Quick Log
                    </span>
                  )}
                </div>
