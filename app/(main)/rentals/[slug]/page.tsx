...
export default function BusinessPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <Link href="/rentals" className="text-brand-blue hover:text-brand-blue/80">
            ← Back to Car Rentals
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <Link href="/rentals" className="text-brand-blue hover:text-brand-blue/80 mb-4 inline-block">
          ← Back to Car Rentals
        </Link>
